...
import image16 from '../../assets/images/karachi1.png';
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 mt-2">
        ...
        */}
        ...
        <h1 className="text-5xl mt-16 font-bold text-red-800 text-left mx-12 mb-6">Karachi Marathon 2025</h1>
          ...
          <div className="w-full md:w-1/2 md:px-4">
            <div className="h-full flex flex-col justify-between">
              ...
              <div className="flex justify-center">
                <a href="https://karachimarathon.org/about-us/" target="_blank" rel="noopener noreferrer" className="bg-red-600 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full inline-block">Visit Karachi Marathon Website for Details</a>
              </div>
            </div>
          </div>
