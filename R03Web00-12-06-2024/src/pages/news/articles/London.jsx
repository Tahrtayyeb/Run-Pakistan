...
const LondonMarathon2024 = () => {
  const menResults = [
    {
      position: '1st place, gold medalist(s)',
      athlete: 'Alexander Mutiso',
      nationality: 'Kenya',
      time: '02:04:01',
    },
    {
      position: '2nd place, silver medalist(s)',
      athlete: 'Kenenisa Bekele',
      nationality: 'Ethiopia',
      time: '02:04:15',
    },
    {
      position: '3rd place, bronze medalist(s)',
  ...
  return (
    <>
      <Helmet>
        ...
        <script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8205461782762104"
          ...
          <div className="max-w-3xl mx-auto flex flex-col">
            <article className="blog-post">
              ...
              <p className="mb-4">
                ...
                This year's version of the famous race was not as it were
                checked by extraordinary athletic accomplishments but moreover
              ...
              <div className="flex flex-wrap justify-center mb-8">
                ...
                <div className="max-w-xs mx-2 mb-4">
                  <img
                    ...
                    style={{ maxWidth: '300px', height: 'auto' }}
                  />
                  <p className="text-center text-sm mt-2">Usman Muhammad</p>
                </div>
                  ...
                  <tbody>
                    {menResults.map((result, index) => (
                      <tr key={index}>
                        ...
                        <td className="border px-4 py-2">{result.athlete}</td>
              ...
              <table className="w-full mb-8">
                ...
                <tbody>
                  {pakistaniRunners.map((runner, index) => (
                    <tr key={index}>
                      <td className="border px-4 py-2">{runner.name}</td>
                      <td className="border px-4 py-2">{runner.time}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
