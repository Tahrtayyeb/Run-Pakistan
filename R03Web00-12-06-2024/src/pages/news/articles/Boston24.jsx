...
const BostonMarathon2024 = () => {
  return ( 
            <>
              ...
              <div className="container mx-auto px-1 py-8 mt-2 flex flex-wrap">
                <div className="max-w-3xl mx-auto flex flex-col mt-20">
                      ...
                      <div className="overflow-x-auto mt-8">
                        <table className="table-auto w-full border-collapse">
                          ...
                          <tbody className="text-center">
                            <tr>
                              <td className="border px-4 py-2">1st place, gold medalist(s)</td>
                            ...
                            <tr>
                              <td className="border px-4 py-2">2nd place, silver medalist(s)</td>
                              <td className="border px-4 py-2">Mohamed Esa</td>
                              <td className="border px-4 py-2">Ethiopia</td>
                              <td className="border px-4 py-2">2:06:58</td>
                            </tr>
                            <tr>
                              <td className="border px-4 py-2">3rd place, bronze medalist(s)</td>
                      ...
                      <div className="max-w-2xl mx-auto flex flex-col">
                          <article className="blog-post">
                            ...
                            <div className="flex flex-wrap justify-center mb-8">
                              ...
                              <div className="max-w-xs mx-2 mb-4">
                                <img src={image73} alt="Jasmine Paris at Barkley Marathon" className="rounded-md" style={{ height: '450px', width: '400px' }}></img>
