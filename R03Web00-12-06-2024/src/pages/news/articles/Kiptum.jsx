...
const KiptumArticle = () => {
  return (
    <>
      ...
      <div className="container mx-auto px-4 mt-2 py-8 flex flex-wrap">
        <div className="w-full md:w-3/4 mt-20">
          <div className="max-w-3xl mx-auto flex flex-col">
            <article className="blog-post">
              <h1 className="text-green-800 text-3xl font-bold mb-4">Kelvin Kiptum: A Legend of Modern Day</h1>
              <p className="mb-4">
        ...
        {/* <aside className="w-full md:w-1/4 md:pl-8 flex flex-col">
          <div className="mb-8 text-center h-28">
            <img src="ad2.jpg" alt="Advertisement 1" className="mx-auto h-full">
          </div>
