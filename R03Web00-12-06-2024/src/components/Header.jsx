...
function Header() {
  ...
  return (
    <>
      <div className='bg-white text-green-800 font-bold flex justify-between items-center p-1'>
        <div className='text-sm ml-12'>
          {currentDate} {currentTimeString}
        </div>
        {/* Backend 
        <div className='mr-10'>
          <NavLink to='#' className='text-sm font-bold text-white hover:bg-green-600 hover:rounded-2xl ease-in-out duration-150 px-4 py-1 focus:outline-none'>Login</NavLink>
          <NavLink to='#' className='text-sm font-bold text-white hover:bg-green-600 hover:rounded-2xl ease-in-out duration-150 px-4 py-1 focus:outline-none ml-2'>Register</NavLink>
        </div>
        */}
      </div>
