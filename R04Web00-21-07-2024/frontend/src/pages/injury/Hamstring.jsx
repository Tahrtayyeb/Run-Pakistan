...
import image100 from '../../assets/images/hamstring.jpg';
import image101 from '../../assets/images/hamstring2.jpg';
...
const HamstringInjuries = () => {
  const pageUrl = "https://www.runpakistan.com/injury-hamstring";
  const pageTitle = "Understanding Hamstring Injuries in Runners";  
              ...
              <div className="mb-8">
                <div className="flex flex-wrap items-center">
                  ...
                  <div className="w-full md:w-1/2 pl-4">
                    ...
                    <p className="text-gray-600 text-center">Foam rolling to improve mobility</p>
                  </div>
                </div>
              </div>
