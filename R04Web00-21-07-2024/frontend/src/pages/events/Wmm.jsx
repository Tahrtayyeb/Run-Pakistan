...
const ShareButtons = ({ url, title }) => {
  return (
    <div className="flex space-x-4 mx-64 mt-4">
...
const AbbottWorldMarathonMajors = () => {
  const pageUrl = "https://www.runpakistan.com/abbot-world-major-marathons";
  const pageTitle = "Abbott World Marathon Majors";
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 md:mt-2 flex flex-wrap">
        {/* Main Content */}
        <div className="w-full md:w-3/4 md:mt-16">
          <div className="max-w-3xl mx-auto">
            <article className="blog-post">
              <h1 className="text-3xl font-bold text-left mx-16 mb-4">Abbott World Marathon Majors</h1>
              <ShareButtons url={pageUrl} title={pageTitle} />
              <p className="mb-4 mt-5">The Abbott World Marathon Majors (Abbott WMM) is a series consisting of six of the largest and most renowned marathons in the world. These races attract elite athletes, avid runners, and spectators from across the globe. Here's an overview of the six major marathons:</p>
              ...
              <div className="mb-8 flex items-center flex-wrap">
                ...
                <div className="w-full md:w-1/2 md:pl-4">
                  <h2 className="text-xl font-semibold mb-2 mt-3">Boston Marathon</h2>
              ...
              <div className="mb-8 flex items-center flex-wrap">
                ...
                <div className="w-full md:w-1/2 md:pl-4">
                  <h2 className="text-xl font-semibold mb-2 mt-3">London Marathon</h2>
              ...
              <div className="mb-8 flex items-center flex-wrap">
                ...
                <div className="w-full md:w-1/2 md:pl-4">
                  <h2 className="text-xl font-semibold mb-2 mt-3">Berlin Marathon</h2>
              ...
              <div className="mb-8 flex items-center flex-wrap">
                ...
                <div className="w-full md:w-1/2 md:pl-4">
                  <h2 className="text-xl font-semibold mb-2 mt-3">Chicago Marathon</h2>
              ...
              <div className="mb-8 flex items-center flex-wrap">
                ...
                <div className="w-full md:w-1/2 md:pl-4">
                  <h2 className="text-xl font-semibold mb-2 mt-3">New York City Marathon</h2>
              ...
              <div className="mb-8 flex items-center flex-wrap">
                ...
                <div className="w-full md:w-1/2 md:pl-4">
                  <h2 className="text-xl font-semibold mb-2 mt-3">Tokyo Marathon</h2>
