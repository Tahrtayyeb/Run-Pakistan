...
const GaliyatMountainTrail2024 = () => {
  const pageUrl = "https://www.runpakistan.com/galiyat-mountain-trail-2024";
  const pageTitle = "Galiyat Mountain Trail 2024";
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 md:mt-2">
        <h1 className="md:mt-16 text-4xl font-bold text-green-700 text-center md:text-left md:mx-16 mb-6">Galiyat Mountain Trail 2024</h1>
