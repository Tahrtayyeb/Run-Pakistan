...
const ShareButtons = ({ url, title }) => {
  return (
    <div className="flex space-x-4 mx-52 mt-4">
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 mt-2">
        <h1 className="text-4xl font-bold text-green-600 text-center md:text-left md:mx-16 mb-6 sm:mt-16">Lahore Marathon 2025!</h1>
