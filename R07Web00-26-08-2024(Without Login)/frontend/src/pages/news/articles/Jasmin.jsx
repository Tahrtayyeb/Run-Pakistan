...
import image61 from '../../../assets/images/jasmin1.jpg';
import image62 from '../../../assets/images/jasmin2.jpg';
import image63 from '../../../assets/images/barkley.jpeg';
...
const JasminBlogPost = () => {
  const pageUrl = "https://www.runpakistan.com/barkley-jasmin-2024";
  const pageTitle = "Jasmine Paris Makes History at Barkley Marathon 2024";  
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Jasmine Paris Makes History at Barkley Marathon 2024</title>
        <meta
          name="description"
          content="Read about Jasmine Paris's historic triumph at the Barkley Marathon 2024, where she became the first woman to conquer the grueling course known for its brutal terrain, strict time limits, and lack of course marking. Discover Jasmine's remarkable journey, overcoming injuries, exhaustion, and doubt to cross the finish line, setting a new milestone in ultrarunning."
        />
        <meta
          name="keywords"
          content="Jasmine Paris, Barkley Marathon, Barkley Marathon 2024, ultrarunning, record-breaking run, women in sports, endurance challenge, historic triumph, overcoming obstacles"
        />
        <meta name="robots" content="index, follow" />
        <link
          rel="canonical"
          href="https://www.runpakistan.com/barkley-jasmin-2024"
        />
        <meta property="og:image" content={image62} /> 
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "NewsArticle",
            "headline": "Jasmine Paris Makes History at Barkley Marathon 2024",
            "image": [
              "https://www.runpakistan.com/assets/images/jasmin1.jpg",
              "https://www.runpakistan.com/assets/images/jasmin2.jpg",
              "https://www.runpakistan.com/assets/images/barkley.jpeg"
            ],
            ...
            "description": "Read about Jasmine Paris's historic triumph at the Barkley Marathon 2024, where she became the first woman to conquer the grueling course known for its brutal terrain, strict time limits, and lack of course marking. Discover Jasmine's remarkable journey, overcoming injuries, exhaustion, and doubt to cross the finish line, setting a new milestone in ultrarunning."
          })}
        </script>
      </Helmet>

      <div className="container md:ml-10 px-4 py-8 mt-2 flex flex-wrap">
        <main className="w-full md:w-3/4 sm:mt-20">
          <div className="max-w-3xl mx-auto flex flex-col">
            <article className="blog-post">
              ...
              <div className="flex flex-wrap justify-center mb-8">
                <div className="max-w-xs mx-2 mb-4 flex justify-center">
                  <img
                    src={image62}
                    alt="Jasmine Paris"
                    className="rounded-md shadow-md md:max-w-lg"                  />
                </div>
              </div>

              <h2 className="text-2xl font-bold mb-2 text-green-800">A Historic Finish</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-bold mb-2 text-green-800">Overcoming Incredible Odds</h2>
              <p className="mb-4">
              ...
              <p className="mb-4">
                During an interview with CNN Sports, she said:
                <blockquote>
                  “All I could do was breathe and that’s all my body was screaming out for: lie down and breathe.”
                </blockquote>
              </p>
              <h2 className="text-2xl font-bold mb-2 text-green-800">Enduring the Final Kilometer</h2>
              <p className="mb-4">
              ...
              <div className="flex flex-wrap justify-center mb-8 mt-10">
                <div className="max-w-xs mx-auto mb-4">
                  <img
                    src={image63}
                    alt="Jasmine Paris at Barkley Marathon"
              ...
              <h2 className="text-2xl font-bold mb-2 text-green-800 mt-4">Jasmine Paris: Training for Success</h2>
              ...
              <h2 className="text-2xl font-bold mb-2 text-green-800 mt-4">A Test of Human Endurance</h2>
              <p className="mb-4">
