...
const displayNews = function() {
    ...
    const newsItems = [
        { image: "images/london3.jpg", heading: "London Marathon 2024 & Strides of Pakistani Runners", link: "News/Articles/london2024.html" },
        { image: "images/bostonGroup.jpeg", heading: "Highlights of Boston Marathon 2024 & Pakistani Running Community", link: "News/Articles/boston2024.html" },
        { image: "images/geezer.jpg", heading: "Hardest Geezer Running Through Africa", link: "News/Articles/hardestGeezer.html" },
        { image: "images/kiptumCar.jpeg", heading: "Kiptun Sad Demise Left Running World in Shock", link: "News/Articles/kiptum.html" },
        { image: "images/beijing2.jpeg", heading: "Huge Controversy at Beijing Half Marathon left Spectators Stunned", link: "News/Articles/beijing2024.html" },
        { image: "images/jasmin2.jpg", heading: "Jasmin Paris Makes History at Barkley Marathon", link: "News/Articles/jasmin2024.html" }
    ];
    
    // Loop through the array of news items and create news cards
    newsItems.forEach(news => {
        const newsCard = document.createElement("div");
        newsCard.classList.add("bg-white", "rounded-lg", "shadow-md", "overflow-hidden", "relative");
...
const upcomingEvents = [
    { title: "Galiyat Mountain Trail 2024", date: "21 July 2024", location: "Nathia Gali Club",  organiser: "Margalla Trail Runners" ,link: "./Events/mtrGaliyat.html", image: "images/galiyat.png" },
    { title: "Margalla Backyard Ultra 2024", date: "07 Dec 2024", location: "Fatima Jinnah Park Islamabad", organiser: "Margalla Trail Runners" , link: "./Events/mtrBackyard2024.html", image: "images/backyard24.jpg" },
    { title: "Capital Half Marathon 2024", date: "To be announced", location: "Islamabad City", organiser: "Islamabad Running Club" , link: "./Events/ircIslamabad2024.html", image: "images/capitalHM.png" },
    { title: "Karachi Marathon 2025", date: "To be announced", location: "Sea View Karachi", organiser: "Sea View Running Club", link: "./Events/svrcKarachi.html", image: "images/karachi1.png" },
    { title: "Islamabad Marathon 2025", date: "26 Jan 2025", location: "Islamabad City", organiser: "Islamabad Run With Us" , link: "./Events/iruIslamabad2025.html", image: "images/iru2025.jpg" },
    { title: "Lahore Marathon 2025", date: "16 Feb 2025", location: "Lahore City", organiser: "Falcon Triathlon Club" , link: "./Events/ftcLahore.html", image: "images/ftc2025.jpg" },
];
...
for (let i = 0; i < Math.min(upcomingEvents.length, 8); i++) {
    ...
    const eventCard = document.createElement("a"); // Changed to anchor element
    eventCard.href = event.link; // Set the href attribute to the event page URL
    eventCard.target = "_blank"; // Open link in new tab

    // Styling for event card
    eventCard.classList.add("bg-white", "p-6", "rounded-md", "shadow-md", "mx-2");
    ...
    const trainingPlans = [
        { type: "", duration: "6 weeks", description: "Get ready to run your first 5k with this 6-week training plan.", link: "Training/5km.html", image: "images/Tcard1.png" },
        { type: "", duration: "8 weeks", description: "Train for a 10k race with this 8-week training plan designed for beginners.", link: "Training/10km.html", image: "images/Tcard2.png" },
        { type: "", duration: "12 weeks", description: "Prepare yourself for a half marathon with this 12-week training plan suitable for all levels.", link: "Training/hm.html", image: "images/Tcard3.png" },
        { type: "", duration: "16 weeks", description: "Conquer the full marathon distance with this comprehensive 16-week training plan.", link: "Training/fm.html", image: "images/Tcard4.png" }
    ];
    ...
    trainingPlans.forEach(plan => {
        ...
        planCard.classList.add("bg-white", "p-6", "rounded-md", "shadow-md");
        ...
        anchorElement.innerHTML = `
            ...
            <p class="text-black mb-2">Duration: ${plan.duration}</p>
            <p class="text-black mb-4">${plan.description}</p>
            <a href="${plan.link}" class="text-blue-600 hover:underline hover:text-green-600" target="_blank">View Plan</a>
        `;
...
const healthAndInjuriesData = [
    { title: "Injury Prevention", description: "Learn how to prevent running injuries.", image: "images/yoga8.jpeg", link: "Health/injuryPrevention.html" },
    { title: "Nutrition For Athletes", description: "Explore the importance of nutrition for runners.", image: "images/nutrition3.jpeg", link: "Health/nutrition.html" },
    { title: "Is Running Bad For Knees", description: "Let's find what science says about running is good or bad for knees", image: "images/run-1.jpg", link: "Health/Knee/isRunningBad.html" },
    { title: "Recovery Techniques", description: "Discover effective recovery techniques for runners.", image: "images/squat7.jpeg", link: "Health/recoveryTech.html" }
