    ...
    const fetchAndInjectNavbar = function() {
        ...
        fetch('navbar.html')
            ...
            .then(data => {
                ...
                if (logo) {
                    logo.src = "images/logo.png"; // Update the path as needed
                } else {
...
// Reattach event listeners for dropdown menus, including the knee dropdown
...
// Call the reattachDropdownEventListeners function after injecting the navbar HTML
reattachDropdownEventListeners();
