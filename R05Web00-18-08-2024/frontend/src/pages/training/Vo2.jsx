...
const VO2MaxImportance = () => {
  ...
  const pageTitle = "VO2 Max Importance for Runners";  
          ...
          <div className="w-full md:w-3/4 md:mt-16">
            <div className="max-w-3xl mx-auto flex flex-col">
              ...
              <div className="flex justify-center mb-4">
                    <img src={image39B} alt="VO2 Max for Men" className="mb-4 rounded-md" />
                </div>
                ...
                <p>Following is VO2 Max chart for men with age group (Source: Garmin)</p>
                <div className="flex justify-center mb-4">
                    <img src={image39A} alt="VO2 Max for Men" className="mb-4 mt-10 rounded-md" style={{ maxWidth: '100%', height: '200px' }} />
                </div>
                <p>Following is VO2 Max chart for women with age group (Source: Garmin)</p>
                <div className="flex justify-center mb-4">
