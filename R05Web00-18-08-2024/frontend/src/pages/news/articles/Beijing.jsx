...
const BeijingMarathonArticle = () => {
  const pageUrl = "https://www.runpakistan.com/beijing-contro-2024";
  const pageTitle = "Beijing Half Marathon 2024 Controversy";  
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:image" content={image60} /> 
        <meta name="author" content="runPAKISTAN" />
      </Helmet>

      <main className="container md:ml-10 mt-2 px-4 py-8 flex flex-wrap">
