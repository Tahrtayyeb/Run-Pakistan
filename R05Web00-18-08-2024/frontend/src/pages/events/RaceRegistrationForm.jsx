    ...
    <div className="flex justify-center items-center md:mt-24">
      <form onSubmit={onSubmit} className="space-y-4 w-full max-w-xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <h1 className='text-2xl text-center font-bold text-green-800'>
          Run Lahore Time Trial Series - 12th Edition
        </h1>
        <input
          type="text"
        ...
        <div>
          <input
            type="tel"
            placeholder="Mobile Number (e.g., 3331122334)"
            name="mobileNo"
            value={mobileNo}
            onChange={onChange}
            required
            ...
            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          <p className="text-sm text-gray-500 mt-1">Enter 10 digits without spaces or dashes</p>
        </div>
        <input
          type="text"
        ...
        {success && (
          <div className="success text-green-500 text-center font-semibold mt-4">
            {success}
          </div>
        )}
      </form>
