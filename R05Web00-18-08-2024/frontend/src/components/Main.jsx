...
const newsItems = [
    { image: pearlImage, heading: "Highlights & Results of Pearl Half Marathon", link: "/events/pearl-half-marathon-rawalakot-2024" },
    ...
    return (
        ...
        {upcomingEvents.map((event, index) => (
            ...
            <Link to={event.link} target="_blank" className="bg-white p-4 rounded-md shadow-md block h-full">
                <div className="h-52 mb-2 overflow-hidden"> {/* Fixed height container */}
                <img
                    src={event.image}
                    alt="Event Image"
