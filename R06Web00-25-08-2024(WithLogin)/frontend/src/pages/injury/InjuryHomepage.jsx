...
import itImage from '../../assets/images/hamstring1.jpg';
...
const eventItems = [
  {
    to: '/injury-prevention/hamstring-injuries-in-runners',
    src: hamstringImage,
    alt: 'Hamstring Injury',
    title: 'Healing Hamstring: Recovery Strategies',
  },
  {
    to: '/injury/running-surfaces-impact-performance-injury',
    src: surfaceImage,
    alt: 'Running Surface',
