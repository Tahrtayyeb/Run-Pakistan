...
import GaliyatMountainTrail2025 from './pages/events/Galiyat2025.jsx';
...
import RunLahore9 from './pages/news/articles/RunLahore9.jsx';
import Galiyat2024 from './pages/news/articles/Galiyat2024.jsx';
import Pearl2024 from './pages/news/articles/Pearl2024.jsx';
import FaisalShafiMentalHealth from './pages/news/articles/faisalshafi.jsx';
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<Layout />}>
      ...
      <Route path="/galiyat-mountain-trail-2025" element={<GaliyatMountainTrail2025 />} />
      ...
      <Route
        path="/half-marathon-training-plan"
        element={
          <ProtectedRoute>
      ...
      <Route path="/run-lahore-time-trail-9th-edition-hikerpk" element={<RunLahore9 />} />
      <Route path="/events/galiyat-mountain-trail-2024" element={<Galiyat2024 />} />
      <Route path="/events/pearl-half-marathon-rawalakot-2024" element={<Pearl2024 />} />
      <Route path="/blog/faisal-shafi-running-mental-health" element={<FaisalShafiMentalHealth />} />

      
      {/* Injury */}
      <Route path="/injury-homepage" element={<InjuryHomepage />} />
      <Route path="/injury-prevention/hamstring-injuries-in-runners" element={<HamstringInjuries />} />
      ...
      <Route path="/injury/running-surfaces-impact-performance-injury" element={<ImpactOfRunningSurface />} />
