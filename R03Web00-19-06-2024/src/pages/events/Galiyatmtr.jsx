...
import image12 from '../../assets/images/galiyat.jpg';

const GaliyatMountainTrail2024 = () => {
  return (
    <>
      <Helmet>
        <meta charSet="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Galiyat Mountain Trail 2024</title>
        ...
        <link rel="canonical" href="https://www.runpakistan.com/galiyat-mountain-trail-2024" />
      ...
      <div className="container mx-auto px-4 py-8 mt-2">
        ...
        */}
        ...
        <h1 className="sm:mt-16 text-4xl font-bold text-green-700 text-center mx-6 mb-6">Galiyat Mountain Trail 2024</h1>
        ...
        <div className="flex flex-wrap items-stretch">
          ...
          <div className="w-full md:w-1/2 md:px-4">
            <div className="h-full flex flex-col justify-between">
              ...
              <div className="flex justify-center">
                <a href="https://margallatrailrunners.com/galiyatmountaintrail/" target="_blank" rel="noopener noreferrer" className="bg-green-700 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-full inline-block">Visit Margalla Trail Runners Website for Details</a>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            ...
            <img src={image12} alt="MTR Galiyat Picture" className="rounded-lg w-full max-h-96" />
            </a>
          </div>
        </div>
      </div>
...
export default GaliyatMountainTrail2024;
