...
import image135 from '../../../assets/images/run-1.jpg';
import image136 from '../../../assets/images/run-2.jpg';
import image137 from '../../../assets/images/runner5.jpeg';
import image138 from '../../../assets/images/grunner1.jpeg';
...
const ImpactOfRunningSurface = () => {
  return (
    <>
      ...
      <div>
        {/* First Ad Space */}
        {/* <div className="mb-8 text-center h-28 mt-16">
        ...
        <div className="container mx-auto px-4 py-8 mt-2">
          ...
          <div className="max-w-3xl mx-auto sm:mt-16">
            ...
            <article className="blog-post">
              ...
              <h2 className="text-2xl font-bold mb-2">3. Track</h2>
              <p className="mb-4">
        ...
        <div className="mb-8 text-center h-28 mt-20">
          <img src="ad1.jpg" alt="Advertisement 2" className="mx-auto h-full" />
        </div>
        */}
      </div>
    </>
